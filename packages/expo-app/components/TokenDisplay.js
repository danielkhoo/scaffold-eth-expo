...
export default function TokenDisplay(props) {
    ...
    const formattedBalance = (Number(ethers.utils.formatEther(props.tokenBalance)) * props.tokenPrice).toFixed(2)
        ...
        <View style={styles.row}>
            <View style={styles.left}>
                ...
                <View>
                    ...
                    <Text style={styles.tokenBalance}>{ethers.utils.formatEther(props.tokenBalance)} {props.tokenSymbol}</Text>
                </View>
            </View>

            <Text style={styles.dollarBalance}>${formattedBalance}</Text>
        </View>
